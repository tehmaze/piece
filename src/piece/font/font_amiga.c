...
static unsigned char amiga_font_glyphs[256][16] = {
...
static font amiga_font = {
    "amiga",
    (unsigned char *)amiga_font_glyphs,
    8,
    16,
    256
};

LIST_APPEND(fonts, amiga_font);

// Converted from TopazPlus_a1200_v1.0.psf (PSF2)
